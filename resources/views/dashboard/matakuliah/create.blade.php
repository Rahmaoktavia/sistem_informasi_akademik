...
<div class="row">
  ...
  <form action="/dashboard-matakuliah" method="post">
    ...
    <div class="mb-3">
        ...
        name="kode_mk" id="kode_mk" value="{{ old('kode_mk') }}" placeholder="Kode Matakuliah">
        @error('kode_mk')
    ...
    <div class="mb-3">
        ...
        name="nama_mk" id="nama_mk" value="{{ old('nama_mk') }}" placeholder="Nama Matakuliah">
        @error('nama_mk')
            <div class=invalid-feedback>
                {{ $message }}
            </div>
    ...
    <div class="mb-3">
        ...
        name="sks" id="sks" value="{{ old('sks') }}" placeholder="SKS">
        @error('sks')
            <div class=invalid-feedback>
                {{ $message }}
            </div>
